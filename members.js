module.exports = {
    ...
    "axel": {
        name: "Axel Trice",
        mainImg: "axel.webp",
        knownFor: "Being a FIGHTER!!",
        facts: [
            { label: "Birthdate", text: "12/24/25" },
            { label: "Due Date", text: "04/25/26"},
            { label: "Current Home", text: "AI Dupont Hospital" },
            { label: "Parents", text: "Devon and Belle Trice", link: "/familytree/profile/devon_belle" }
        ]
    }
};
